  ...
  const handleOTPComplete = useCallback(
    async (code: string) => {
      ...
      try {
        ...
        router.push('/(auth)/register/age-confirm');
      } catch {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Title */}
        <Text style={styles.title}>Xac nhan email</Text>
        <Text style={styles.subtitle}>
          Nhap ma 6 chu so da gui den email cua ban
        </Text>
        ...
        <Text style={styles.hint}>
          Kiem tra hop thu den hoac thu muc spam
        </Text>
